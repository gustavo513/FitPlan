...
import { UpdatePlanSchema } from "./dto/updatePlanSchema";
...
route.put('/actualizar-plan', [autenticacion, autorizacion(['Estándar'])], validate([UpdatePlanSchema]), actualizarPlanController);
